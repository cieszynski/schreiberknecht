...
class AlignedRange extends StaticRange {
    ...
    constructor(range) {
        ...
        if ((range.startContainer, range.endContainer)
            ...
            console.log(100.2, range.startContainer === range.endContainer);
        ...
        switch (true) {
            ...
            case (node.parentElement.childNodes.length === 1):
                ...
                if (node.parentElement.previousElementSibling) {
                    ...
                    if (areEpNode(node.parentElement.nextElementSibling)) {
                        console.log(99.2621)
                        container = node.parentElement.nextElementSibling;
                        delta = 0;

                    } else {
                        if (areStyleNode(node.parentElement.nextElementSibling.firstChild)) {
                            console.log(99.26221)

                        } else {
                            console.log(99.26222)
                            container = node.parentElement.nextElementSibling.firstChild;
                            delta = 0;
                        }
    ...
    onDeleteContent(range) {
        ...
        if (areTextNode(startContainer, endContainer)) {
            ...
            if (start.container?.isConnected) {
                ...
                if (end.container?.isConnected) {
                    console.log(88.11, start.container, end.container)

                } else {
                    console.log(88.12, start.container)
